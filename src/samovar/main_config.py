...
TOOL_GROUP_ALIASES: Dict[str, str] = {
    ...
    "feature": "annotator",
    "features": "annotator",
    "seq2feature": "annotator",
    "annotator.feature": "annotator",
    "runtime": "runtime",
    "compiler": "compiler",
    ...
    "sample_scoring": "sample_scoring",
    "sample-scoring": "sample_scoring",
    "sample_score": "sample_scoring",
    "sample-score": "sample_scoring",
    "sample_qc": "sample_scoring",
    "sample-qc": "sample_scoring",
    "sampleqc": "sample_scoring",
    "abundance_sample_scoring": "sample_scoring",
    "sample_filtering": "sample_filtering",
    "sample-filtering": "sample_filtering",
    "sample_filter": "sample_filtering",
    "sample-filter": "sample_filtering",
    "abundance_sample_filtering": "sample_filtering",
    "score": "scoring",
    "scoring": "scoring",
    "viz": "scoring",
    ...
    "export": "export",
    "abundance_corrector": "export",
    "abundance_correction": "export",
    "corrector": "export",
    "correction": "export",
    ...
    "gene_annotation": "gene_caller",
    "gene-annotation": "gene_caller",
    "prodigal": "gene_caller",
    "binner": "binner",
    "binning": "binner",
    "binner_qc": "binner_qc",
    "binner-qc": "binner_qc",
    "binner_combine": "binner_combine",
    "binner-combine": "binner_combine",
    "mag_taxonomy": "mag_taxonomy",
    "mag-taxonomy": "mag_taxonomy",
    "aligner": "aligner",
    "align": "aligner",
    "mag_quantifier": "mag_quantifier",
    "mag-quantifier": "mag_quantifier",
    "taxon_quantifier": "taxon_quantifier",
    "taxon-quantifier": "taxon_quantifier",
    "read_assigner": "read_assigner",
    "read-assigner": "read_assigner",
    "workflow": "workflow",
    "wf": "workflow",
}
...
TOOL_GROUP_BY_NAME: Dict[str, str] = {
    ...
    "bray_curtis": "sample_scoring",
    "bray-curtis": "sample_scoring",
    "opal": "scoring",
    "opal.py": "scoring",
    "multiqc": "scoring",
    "fastp": "qc",
    ...
    "metabat2": "binner",
    "checkm2": "binner_qc",
    "dastool": "binner_combine",
    "DAS_Tool": "binner_combine",
    "magscot": "binner_combine",
    "gtdbtk": "mag_taxonomy",
    "minimap2": "aligner",
    "coverm": "mag_quantifier",
    "assembly": "annotator",
    "assembly_profiling": "annotator",
