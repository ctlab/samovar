...
vignette: >
  %\VignetteIndexEntry{Basic samovar usage}
...
If you build teatree by your own, do rescaling stage when building via `rescale_samovar(teatree)` or assigning `teatree$min_value` and `teatree$max_value` is required
