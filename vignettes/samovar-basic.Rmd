...
viz_composition(teatree, type = "tile", interactive = T, top = 10)
```
...
```{r}
new_data <- samovar %>%
  samovar_boil(N = 10, avoid_zero_generations = F)
```


```{r}
viz_composition(new_data, type = "tile", interactive = T, top = 100)
```
